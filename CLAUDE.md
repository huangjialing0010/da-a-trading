...
## 变更与交接记录
当前状态（2026-08-04）：基准价已切换新浪为主/东财兜底；趋势仓数据熔断、深价仓超限处置、终审样本不足顺延、交易成本模型已生效；市场判断台账每周五回填；周报/月报已含双策略组合总览（深价100万+趋势200万按初始资金权重合成净值、回撤、波动对比）；深价仓定位写回左侧交易仓。详细历史见 `docs/CHANGES.md`。
